...
mod tests {
    ...
    mock! {
        ...
        impl UserRepository for UserRepo {
            ...
            async fn update(&self, id: Uuid, name: Option<String>, location: Option<String>, readme: Option<String>, website: Option<String>) -> Result<User, crate::error::DatabaseError>;
