        ...
        },
        {
          ...
          lines: [
            ...
            },
            {
              ...
              oldNum: null,
              newNum: 16,
              content: "  const hours = date.getHours();",
            },
            {
              type: "added",
              oldNum: null,
              newNum: 17,
              content: "  const minutes = date.getMinutes();",
            },
            {
              type: "removed",
              oldNum: 16,
              newNum: null,
              content: "  return date.toLocaleTimeString();",
            },
            {
              type: "added",
              oldNum: null,
      ...
      hunks: [
        {
          ...
          lines: [
            ...
            { type: "context", oldNum: 2, newNum: 3, content: "" },
            {
              ...
              oldNum: 3,
              newNum: null,
              content: "const BASE_URL = 'http://localhost:3000';",
            },
            {
              type: "added",
              oldNum: null,
            ...
            { type: "context", oldNum: 4, newNum: 5, content: "" },
            {
              ...
              oldNum: 5,
              newNum: 6,
              content: "export const client = axios.create({",
            },
            {
              type: "context",
              oldNum: 6,
      ...
      hunks: [
        {
          ...
          lines: [
            ...
            },
            {
              ...
              oldNum: null,
              newNum: 5,
              content: "  const timerRef = useRef<NodeJS.Timeout>();",
            },
            ...
            },
            {
              ...
              oldNum: null,
              newNum: 8,
              content: "    timerRef.current = setTimeout(() => {",
            },
            {
              type: "context",
              oldNum: 8,
              newNum: 9,
              content: "      setDebouncedValue(value);",
            },
            {
              type: "context",
              oldNum: 9,
            ...
            { type: "context", oldNum: 10, newNum: 11, content: "" },
            {
              ...
              oldNum: 11,
              newNum: null,
              content: "    return () => clearTimeout(handler);",
            },
            {
              type: "added",
              oldNum: null,
      ...
      hunks: [
        {
          ...
          lines: [
            ...
            { type: "context", oldNum: 9, newNum: 11, content: "  return (" },
            {
              ...
              oldNum: 10,
              newNum: null,
              content: '    <header className="bg-white shadow">',
            },
            {
              type: "added",
              oldNum: null,
              newNum: 12,
              content: '    <header className="bg-white shadow-sm">',
            },
            {
              type: "context",
              oldNum: 11,
              newNum: 13,
              content: '      <div className="container mx-auto px-4 py-3">',
            },
            {
              type: "removed",
              oldNum: 12,
            ...
            },
            {
              ...
              oldNum: null,
              newNum: 17,
              content: "            onClick={() => setIsMenuOpen(!isMenuOpen)}",
            },
            {
              type: "added",
              oldNum: null,
              newNum: 18,
              content: '            className="md:hidden p-2"',
            },
      ...
      hunks: [
        {
          ...
          lines: [
            ...
            },
            {
              ...
              oldNum: null,
              newNum: 10,
              content: '    "lint": "eslint . --ext .ts,.tsx"',
            },
      ...
      hunks: [
        {
          ...
          lines: [
            ...
            { type: "added", oldNum: null, newNum: 4, content: "  try {" },
            {
              ...
              oldNum: null,
              newNum: 5,
              content: "    z.string().email().parse(email);",
            },
            {
              type: "added",
              oldNum: null,
            ...
            {diff.hunks.map((hunk, hunkIdx) => (
              <div key={hunkIdx} className="font-mono text-sm">
                {hunk.lines.map((line, lineIdx) => (
                  <div
                    key={lineIdx}
                    className="grid grid-cols-[auto_1fr_auto_1fr] hover:bg-gray-50"
                  >
                    {line.type === "removed" && (
                      <>
                        <div className="bg-red-50 text-red-600 px-2 text-right select-none">
                          {line.oldNum}
                        </div>
                    ...
                    {line.type === "added" && (
                      <>
                        <div className="px-2 select-none"></div>
                        <div className=""></div>
                        <div className="bg-green-50 text-green-600 px-2 text-right select-none">
                          {line.newNum}
                        </div>
                    ...
                    {line.type === "context" && (
                      <>
                        <div className="text-gray-400 px-2 text-right select-none">
                          {line.oldNum}
                        </div>
